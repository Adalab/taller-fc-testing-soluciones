// Link: http://tddbin.com/#?kata=es6/language/string-api/endsWith
...
describe('`str.endsWith(searchString)` determines whether `str` ends with `searchString`.', function() {
  ...
  describe('transfer the functionality to other objects', function() {
    ...
    it('also using the position works', function() {
      ...
      /*
      Aquí hay un error, debería decir "also using the length works" por endsWith
      recibe como segundo parametro la longitud. En este caso comprobaría
      si la longitud de 1994 al ser 3 (199) terminaría en "99", cosa que es
      correcta
      */
